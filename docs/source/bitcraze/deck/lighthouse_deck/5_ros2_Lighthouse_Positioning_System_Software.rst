...
----------
   ...
   crazyflie-lib-python python库  `github地址 <https://github.com/bitcraze/crazyflie-lib-python>`_
   
   crazyflie-clients-python python客户端 `github地址 <https://github.com/bitcraze/crazyflie-clients-python/releases>`_
   
   crazyswarm2 ROS2无人机集群库 `github地址 <https://github.com/IMRCLab/crazyswarm2>`_
