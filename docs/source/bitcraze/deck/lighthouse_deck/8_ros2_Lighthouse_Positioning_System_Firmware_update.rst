...
--------------------------------
    ...
    `固件github地址 <https://github.com/bitcraze/crazyflie-release/releases>`_
    Crazyflie无人机集群套件 `采购地址 <https://item.taobao.com/item.htm?ft=t&id=858112103307&spm=a21dvs.23580594.0.0.52de2c1bg17fUu>`_

更新固件
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    `点击下载固件地址 <https://github.com/bitcraze/crazyflie-release/releases>`_，选择cf2版本（cf2是Crazyflie 2.X），选择zip文件，其中包含Crazyflie 2.0的nRF51和STM32F405的固件。
