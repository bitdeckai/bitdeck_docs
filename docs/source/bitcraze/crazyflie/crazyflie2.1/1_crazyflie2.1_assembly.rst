...
.. figure:: ../../../_static/assembly/Crazyflie2.1/all_device.jpg
   :align: center
...
.. raw:: html
   ...
   <div style="text-align: center">
      <video width="100%" height="auto" controls autoplay muted loop>
         <source src="../../../_static/assembly/Crazyflie2.1/1_introduction.mp4" type="video/mp4">
         Your browser does not support the video tag.
      </video>
   </div>
...
.. raw:: html
   ...
   <div style="text-align: center">
      <video width="100%" height="auto" controls autoplay muted loop>
         <source src="../../../_static/assembly/Crazyflie2.1/2_battery.mp4" type="video/mp4">
         Your browser does not support the video tag.
      </video>
   </div>
...
.. raw:: html
   ...
   <div style="text-align: center">
      <video width="100%" height="auto" controls autoplay muted loop>
         <source src="../../../_static/assembly/Crazyflie2.1/3_motor.mp4" type="video/mp4">
         Your browser does not support the video tag.
      </video>
   </div>   
